...
function DownloadButtons() {
  ...
  const macBtn = (
    <a href="/downloads/Sonidata_Embed_1.1.0_universal.dmg" className={os === "win" ? SECONDARY : PRIMARY}>
  ...
  const winBtn = (
    <a href="/downloads/Sonidata_Embed_1.1.0_x64-setup.exe" className={os === "win" ? PRIMARY : SECONDARY}>
