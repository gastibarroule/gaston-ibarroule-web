            ...
            <div className="flex gap-0">
                <article className="flex-1 min-w-0 max-w-3xl pb-20">
                    ...
                    <div className="flex items-center gap-1.5 text-[12px] text-neutral-600 mb-8">
                        <Link href="/sonidata" className="hover:text-neutral-300 transition-colors">Sonidata</Link>
                    ...
                    <div className="mt-14 pt-8 border-t border-white/6 flex justify-between items-center">
                        {prevItem ? (
                            <Link href={`/sonidata/${prevItem.id}`} className="group flex items-center gap-2 text-[13px] text-neutral-500 hover:text-white transition-colors">
        ...
        <div className="flex gap-0">
            <article className="flex-1 min-w-0 max-w-3xl pb-20">
                ...
                <div className="mt-14 pt-8 border-t border-white/6 flex justify-between items-center">
                    ...
                    {nextItem ? (
                        <Link href={`/sonidata/${nextItem.id}`} className="group flex items-center gap-2 text-[13px] text-neutral-500 hover:text-white transition-colors">
